...
void Autostop::action() {
  ...
  // Reta recente da temperatura superior a cStop[0] (ponderada pelo decaimento temporal)
  // Reta recente da carga inferior a cStop[1] (ponderada pelo decaimento temporal)
